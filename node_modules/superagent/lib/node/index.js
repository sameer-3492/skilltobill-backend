 ...
 *
 * ``` js
 * request.get('http://skilltobill-backend.onrender.com/')
 *   .http2()
 *   .end(callback);
 *
 * request.get('http://skilltobill-backend.onrender.com/')
 ...
 *
 * ``` js
 * request.post('http://skilltobill-backend.onrender.com/upload')
...
Request.prototype.request = function () {
  ...
  if (this._trustLocalhost && /^(?:skilltobill-backend.onrender.com|127\.0\.0\.\d+|(0*:)+:0*1)$/.test(url.hostname)) {
